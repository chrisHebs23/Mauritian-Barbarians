(self.webpackChunkreact_webpack_boilerplate=self.webpackChunkreact_webpack_boilerplate||[]).push([[945,544],{1296:(e,t,i)=>{"use strict";i.d(t,{Z:()=>r});var a=i(9526),n=i(3177);const r=e=>{const[t,i]=(0,a.useState)([]);return(0,a.useEffect)((()=>{const t=n.RZ.collection(e).orderBy("createdAt","desc").onSnapshot((e=>{let t=[];e.forEach((e=>{t.push({...e.data(),id:e.id})})),i(t)}));return()=>t()}),[e]),{docs:t}}},2544:(e,t,i)=>{"use strict";i.r(t),i.d(t,{Title:()=>g,default:()=>f});var a=i(9526),n=i(2326),r=i(9839),l=i(8253);const c=(0,n.ZP)(l.E.div)`
  position: fixed;
  top: 0;
  left: 0;
  margin: 0;
...
`,s=({setSelectedImg:e})=>{const{docs:t}=(0,n.Z)("images");return a.createElement(c,null,t&&t.map((t=>a.createElement(o,{key:t.id,onClick:()=>e(t.url)},a.createElement(m,{src:t.url})))))}},7945:(e,t,i)=>{"use strict";i.r(t),i.d(t,{default:()=>Z});var a=i(9526),n=i(2326),r=i(3177);var l=i(8253),c=i(4180);const o=(0,n.ZP)(l.E.div)`
  height: 5px;
  background: ${c.D0};
  margin-top: 20px;
`,m=({file:e,setFile:t})=>{const{progress:i,url:n}=(e=>{const[t,i]=(0,a.useState)(0),[n,l]=(0,a.useState)(null),[c,o]=(0,a.useState)(null);return(0,a.useEffect)((()=>{const t=r.tO.ref(e.name),a=r.RZ.collection("sponsors");t.put(e).on("state_change",(e=>{let t=e.bytesTransferred/e.totalBytes*100;i(t)}),(e=>{l(e)}),(async()=>{const e=await t.getDownloadURL(),i=(0,r.AB)();a.add({url:e,createdAt:i}),o(e)}))}),[e]),{progress:t,url:c,error:n}})(e);return console.log(i,n),(0,a.useEffect)((()=>{n&&t(null)}),[n,t]),a.createElement(o,{initial:{width:0},animate:{width:i+"%"}})},s=n.ZP.form`
...
`,x=({setSelectedImg:e})=>{const{docs:t}=(0,u.Z)("sponsors");return a.createElement(p,null,t&&t.map((t=>a.createElement(f,{key:t.id,onClick:()=>e(t.url)},a.createElement(w,{src:t.url})))))};var E=i(2544),b=i(1070),v=i(5092);const y=n.ZP.div`
  margin-left: 2%;
`,k=n.ZP.button`
  width: 10rem;
  margin: 5%;
